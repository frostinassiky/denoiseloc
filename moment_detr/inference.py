...
def compute_mr_results(
    ...
    for batch in tqdm(eval_loader, desc="compute st ed scores"):
        ...
        if opt.span_loss_type == "l1":
            scores = prob[
                ..., 0
            ]  # * (batch_size, #queries)  foreground label is 0, we directly take it
...
def start_inference():
    ...
    torch.backends.cudnn.deterministic = True  # too slow
    ...
    logger.info(
        "metrics_no_nms {}".format(pprint.pformat(metrics_no_nms["brief"], indent=4))
    )
