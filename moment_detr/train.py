...
def start_training():
    ...
    print(
        f"use_sparse_rcnn={opt.use_sparse_rcnn}, num_queries={opt.num_queries}, snr_scale={opt.snr_scale}"
    )
    print(
        f"enc_layers={opt.enc_layers}, dec_layers={opt.dec_layers}, dropout={opt.dropout}"
    )
    print(
        f"set_cost_class={opt.set_cost_class}, set_cost_giou={opt.set_cost_giou}, set_cost_span={opt.set_cost_span}"
    )
    print(
        f"label_loss_coef={opt.label_loss_coef}, giou_loss_coef={opt.giou_loss_coef}, span_loss_coef={opt.span_loss_coef}"
    )
